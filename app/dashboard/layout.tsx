...
const sidebarLinks = [
  ...
  { href: "/dashboard/intake", label: "Medical Intake", icon: ClipboardList },
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 px-4 py-5">
        ...
        <span className="text-lg font-bold text-foreground">Patient Portal</span>
      </div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-14 items-center justify-between border-b border-border bg-background px-4 lg:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-bold text-foreground">Patient Portal</span>
          </div>
